...
# AWS remote cells use one enqueue driver (`BOSON_BENCH_BC1_ENQUEUE_ONLY=1`) and
# N worker hosts (`BOSON_BENCH_BC1_WORKER_ONLY=1`) against one Redis. Bound offered
# work with `BOSON_BENCH_BC1_JOB_COUNT`.
