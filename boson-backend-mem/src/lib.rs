...
//!
//! **Topology:** Embedded only — state lives in this process and cannot be shared with a
//! remote worker. For remote worker (enqueue host + worker binary), use `SQLite`, Postgres, Redis, or NATS.
