...
- Check: `cargo check -p boson --features mem,telemetry-console,axum`
...
cargo check -p boson --features mem,telemetry-console,axum
cargo doc -p boson --features mem,telemetry-console,axum --no-deps
```
